 ...
 */
public strictfp class FloatingDecimal2{
    //
    ...
    static class BinaryToASCIIBuffer implements BinaryToASCIIConverter {
        ...
        private void developLongDigits( int decExponent, long lvalue, int insignificantDigits ){
            if ( insignificantDigits != 0 ){
                ...
                long pow10 = FDBigInteger2.LONG_5_POW[insignificantDigits] << insignificantDigits; // 10^i == 5^i * 2^i;
        ...
        private void dtoa( int binExp, long fractBits, int nSignificantBits, boolean isCompatibleFormat)
        {
            ...
            if ( binExp <= MAX_SMALL_BIN_EXP && binExp >= MIN_SMALL_BIN_EXP ){
                ...
                // a long.
                if ( (nTinyBits < FDBigInteger2.LONG_5_POW.length) && ((nFractBits + N_5_BITS[nTinyBits]) < 64 ) ){
                    //
                    // We can do this:
            ...
            if ( Bbits < 64 && tenSbits < 64){
                if ( Bbits < 32 && tenSbits < 32){
                    ...
                    int b = ((int)fractBits * FDBigInteger2.SMALL_5_POW[B5] ) << B2;
                    int s = FDBigInteger2.SMALL_5_POW[S5] << S2;
                    int m = FDBigInteger2.SMALL_5_POW[M5] << M2;
                    int tens = s * 10;
                    //
                    ...
                    long b = (fractBits * FDBigInteger2.LONG_5_POW[B5] ) << B2;
                    long s = FDBigInteger2.LONG_5_POW[S5] << S2;
                    long m = FDBigInteger2.LONG_5_POW[M5] << M2;
                    long tens = s * 10L;
                    //
                    // Unroll the first iteration. If our decExp estimate
                    // was too high, our first quotient will be zero. In this
                ...
                //
                FDBigInteger2 Sval = FDBigInteger2.valueOfPow52(S5, S2);
                int shiftBias = Sval.getNormalizationBias();
                Sval = Sval.leftShift(shiftBias); // normalize so that division works better

                FDBigInteger2 Bval = FDBigInteger2.valueOfMulPow52(fractBits, B5, B2 + shiftBias);
                FDBigInteger2 Mval = FDBigInteger2.valueOfPow52(M5 + 1, M2 + shiftBias + 1);

                FDBigInteger2 tenSval = FDBigInteger2.valueOfPow52(S5 + 1, S2 + shiftBias + 1);                 //
                // Unroll the first iteration. If our decExp estimate
                // was too high, our first quotient will be zero. In this
                // case, we discard it and decrement decExp.
                //
                ...
                exactDecimalConversion  = (Bval.cmp( FDBigInteger2.ZERO ) == 0);
            }
    ...
    static class ASCIIToBinaryBuffer implements ASCIIToBinaryConverter {
        ...
        public double doubleValue() {
            ...
            FDBigInteger2 bigD0 = new FDBigInteger2(lValue, digits, kDigits, nDigits);
            ...
            while (true) {
                ...
                FDBigInteger2 bigB = FDBigInteger2.valueOfMulPow52(bigBbits, B5, B2);
        ...
        public float floatValue() {
            ...
            FDBigInteger2 bigD0 = new FDBigInteger2(iValue, digits, kDigits, nDigits);
            exp = decExponent - nDigits;
